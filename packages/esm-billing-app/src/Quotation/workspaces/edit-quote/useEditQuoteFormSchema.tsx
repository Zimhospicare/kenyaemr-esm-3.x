 ...
 */
export const useEditQuoteFormSchema = () => {
...
export type EditQuoteFormData = z.infer<ReturnType<typeof useEditQuoteFormSchema>>;
 ...
 */
export const useDefaultEditQuoteFormValues = (billLineItem: LineItem, existingBill: MappedBill): EditQuoteFormData => {
  return {
